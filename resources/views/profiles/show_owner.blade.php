...
@section('content')
    <div class="section-body mt-4">
        <owner-profile-page inline-template :user="{{$user}}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <img class="card-img-top" :src="localUser.image" :title="localUser.name">
                            <div class="card-body text-center">
                                <h3>
                                    <strong v-text="localUser.name"></strong>
                                </h3>
                                <h5 v-text="localUser.formattedUsername"></h5>
                                <span class="badge badge-success">
                                    <i class="fa fa-dot-circle"></i> @{{localUser.points}}
                                </span>
                                <hr>
                                <div class="row">
                                    <div class="col-4">
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#profile-setting" role="tab" aria-controls="profile-setting" aria-selected="false">{{__('profiles.settings')}}</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="profile-setting" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="header-title">{{__('profiles.settings')}}</h3>
                                    </div>
                                    <profile-edit-form :user="localUser" @updated="update"></profile-edit-form>
                                </div>
                            </div>
                            <div class="tab-pane fade show active" id="pills-blog" role="tabpanel" aria-labelledby="pills-blog-tab">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="header-title">{{__('posts.create')}}</h4>
                                    </div>
                                    <div class="card-body">
