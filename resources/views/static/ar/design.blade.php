...
<head>
    ...
    <!-- Style CSS -->
    <link rel="stylesheet" href="/theme0/css/style.rtl.css">
    @stack('styles')
            ...
            <div class="navbar-inner pl-lg-2 pl-xl-6">
                ...
                <nav>
                    <ul class="navbar-nav" id="navbar-nav">
                        <li>
                            <a class="nav-link" href="{{route('bands.request')}}">اضف فريقك</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{route('tickets.request')}}">أحصل على تذكرة من فريق</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{route('login')}}">تسجيل الدخول</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{route('register')}}">انضم لفريقك</a>
                        </li>
                        <li class="nav-link">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-9 col-lg-7 mb-4 mb-xl-0">
                            <div class="pr-xl-3" style="text-align: center">
                                <a class="navbar-brand" href="{{route('home')}}">
                                    <img class="navbar-brand__regular mb-1" src="{{site('logo')}}" height="70" alt="{{site('name')}}">
                                    <img class="navbar-brand__sticky" src="{{site('logo')}}" height="70" alt="{{site('name')}}">
                                    <h3 class="d-inline"><b>XM</b>entee</h3>
                                ...
                                <p class="text-center">
                                     هو موقع ادارة اونلاين للفرق المتقدمة, إذا كنت معلم او مدرب و مدير فريق يمكنك ادارة فريقك بسهولة من خلاله
                                </p>
                            </div>
                        </div>
                        <!-- end of col -->
                        <div class="col-6 col-md-6 col-lg-6 col-xl-2 mb-2 mb-xl-0">
                            <div class="widget widget-nav">
                                <span class="widget__title font-size--20 font-w--700 mb-1">روابط سريعة</span>
                                <ul>
                                    <li><a href="{{route('bands.request')}}">انشاء مجموعة</a></li>
                                    <li><a href="{{route('login')}}">تسجيل الدخول</a></li>
                                    <li><a href="{{route('tickets.request')}}">اطلب تذكرة من فريق</a></li>
                                    <li><a href="{{route('register')}}">انضم لفريقك</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- end of widget col-->
                        <div class="col-6 col-md-6 col-lg-6 col-xl-2 offset-xl-1 mb-2 mb-xl-0">
                            <div class="widget widget-nav">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#" data-toggle="modal" data-target="#termsModal">شروط الاستخدام</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <span class="font-size--15 opacity--80">
                                © 2020 <b class="color--white">XMentee</b>
                                جميع الحقوق محفوظة
                            </span>
                        </div>
                    </div>
